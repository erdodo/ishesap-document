        ...
        <div class="container">
          <el-card class="w-100 mb-3">
            <el-breadcrumb separator-class="el-icon-arrow-right">
              ...
              <el-breadcrumb-item>Çek işlemleri</el-breadcrumb-item>
            </el-breadcrumb>
          </el-card>
          <!--begin::Content-->
          <!--begin::Post-->
          <div class="post" id="kt_post">
            ...
            <div class="mb-10">
              ...
              <div class="mb-0">
                ...
                <div class="d-flex align-items-center mb-4">
                  <!--begin::Title-->
                  <h1 class="fs-2 fw-bolder text-gray-900 text-hover-primary me-1" ref="cekIslemleri">
            ...
            <!--begin::Pagination-->
            <div class="d-none">
              <router-link to="/docs/finans-yonetimi/banka"
