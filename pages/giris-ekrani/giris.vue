        ...
        <div class="container">
          <el-card class="w-100">
            <el-breadcrumb separator-class="el-icon-arrow-right">
              ...
              >
              <el-breadcrumb-item :to="{ path: '/giris-ekrani' }"
                >Giriş Ekranı</el-breadcrumb-item
              >
              <el-breadcrumb-item>Giriş</el-breadcrumb-item>
            </el-breadcrumb>
          </el-card>
          <!-------  KODLAR BURAYA  --------->
          <div class="post mt-3" style="width: auto" id="kt_post">
            ...
            <div class="mb-10">
              ...
              <div class="mb-0">
                ...
                <!--end::Head-->
                <!--begin::Summary-->
                <div class="fs-base fw-normal text-gray-700 mb-4 docText">
            ...
            <div class="d-flex justify-content-between mb-0 footers container">
              ...
              >
              <router-link
                to="/giris-ekrani/sifremi-unuttum"
                class="btn btn-light btn-active-light-primary fw-bold fs-6 mx-2"
                >Sonraki</router-link
              >
            </div>
...
export default {
  data() {
    return {
      url: "/img/giris-ekrani.png",
      srcList: ["/img/giris-ekrani.png"],
    };
  },
};
</script>
